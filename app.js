...
function renderScore() {
  ...
  scoreContainer.innerHTML = `<h2>Percentage of Correctly Answered Question: ${scorePercentage}</h2>`;
  scoreContainer.innerHTML = `<h2>Number of Correctly Answered Question: ${score}</h2>`;
}
